...
<div class="card">
    <div class="card-header">
        <h6 class="m-0 font-weight-bold text-primary">Tambah Motor Baru</h6>
    </div>
    <div class="card-body">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?= form_error('merk') ? 'is-invalid' : '' ?>" 
                            id="merk" name="merk" value="<?= set_value('merk') ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?= form_error('model') ? 'is-invalid' : '' ?>" 
                            id="model" name="model" value="<?= set_value('model') ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control <?= form_error('tahun') ? 'is-invalid' : '' ?>" 
                            id="tahun" name="tahun" value="<?= set_value('tahun') ?>">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?= form_error('warna') ? 'is-invalid' : '' ?>" 
                            id="warna" name="warna" value="<?= set_value('warna') ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control <?= form_error('harga') ? 'is-invalid' : '' ?>" 
                            id="harga" name="harga" value="<?= set_value('harga') ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control <?= form_error('stok') ? 'is-invalid' : '' ?>" 
                            id="stok" name="stok" value="<?= set_value('stok') ?>">
