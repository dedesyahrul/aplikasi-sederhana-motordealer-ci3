                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control <?= form_error('tanggal_jual') ? 'is-invalid' : '' ?>" 
                            id="tanggal_jual" name="tanggal_jual" value="<?= set_value('tanggal_jual', $sale->tanggal_jual) ?>">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control <?= form_error('harga_jual') ? 'is-invalid' : '' ?>" 
                            id="harga_jual" name="harga_jual" value="<?= set_value('harga_jual', $sale->harga_jual) ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select <?= form_error('metode_pembayaran') ? 'is-invalid' : '' ?>" 
                            ...
                            <option value="Cash" <?= set_select('metode_pembayaran', 'Cash', ($sale->metode_pembayaran == 'Cash')) ?>>Cash</option>
                            <option value="Credit Card" <?= set_select('metode_pembayaran', 'Credit Card', ($sale->metode_pembayaran == 'Credit Card')) ?>>Credit Card</option>
                            <option value="Debit" <?= set_select('metode_pembayaran', 'Debit', ($sale->metode_pembayaran == 'Debit')) ?>>Debit</option>
                            <option value="Transfer" <?= set_select('metode_pembayaran', 'Transfer', ($sale->metode_pembayaran == 'Transfer')) ?>>Transfer</option>
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="keterangan" name="keterangan" rows="3"><?= set_value('keterangan', $sale->keterangan) ?></textarea>
                    </div>
                </div>
            </div>
