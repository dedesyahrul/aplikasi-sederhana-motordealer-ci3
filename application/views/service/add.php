                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="vehicle_brand" id="vehicle_brand" class="form-control <?= form_error('vehicle_brand') ? 'is-invalid' : '' ?>" value="<?= set_value('vehicle_brand') ?>" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="vehicle_model" id="vehicle_model" class="form-control <?= form_error('vehicle_model') ? 'is-invalid' : '' ?>" value="<?= set_value('vehicle_model') ?>" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="vehicle_year" id="vehicle_year" class="form-control <?= form_error('vehicle_year') ? 'is-invalid' : '' ?>" value="<?= set_value('vehicle_year') ?>" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="vehicle_number" id="vehicle_number" class="form-control <?= form_error('vehicle_number') ? 'is-invalid' : '' ?>" value="<?= set_value('vehicle_number') ?>" required>
                            <div class="invalid-feedback">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="complaints" id="complaints" rows="3" class="form-control <?= form_error('complaints') ? 'is-invalid' : '' ?>" required><?= set_value('complaints') ?></textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="service_cost" id="service_cost" class="form-control <?= form_error('service_cost') ? 'is-invalid' : '' ?>" value="<?= set_value('service_cost') ?>" required>
                            <div class="invalid-feedback">
